...
triggerall = !var(17)
triggerall = NumProj = 0
triggerall = Command = "Screw Upper_MAX"
trigger1 = Power >= 2000 && var(30)=0 && var(47)=0
trigger2 = Power >= 1000 && var(30)=1 && fvar(0) > 0
triggerall = !StateType = A && (Ctrl || (var(40)=[1,3]))
...
[State -1]
type = ChangeState
value = IfElse(var(10)=1,1020,1010)
triggerall = !var(17)
triggerall = NumProj = 0
...
[State -1]
type = ChangeState
value = IfElse(var(10)=1,1600,1100)
...
[State -1]
type = ChangeState
value = IfElse(var(10)=1,1610,1110)
...
value = 1700
triggerall = var(10)=1
triggerall= Command = "Pressure Knee"
triggerall= StateType != A
trigger1 = Ctrl || (var(40)=[1,3])
trigger2 = var(30) = 2 && var(40) = 4 && (StateNo != [1700,1799])
ignorehitpause = (var(40) = 4)
...
[State -1]
type = ChangeState
value = IfElse(var(10)=1,1500,1400)
...
[State -1]
type = ChangeState
value = IfElse(var(10)=1,1550,1450)

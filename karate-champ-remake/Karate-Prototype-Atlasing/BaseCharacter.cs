            ...
            switch (state) {
                ...
                case State.PunchShort:
                    ...
                    if (Keyboard.GetState().IsKeyDown(Keys.Right))
                        animatorator.PlayTo(MainGame.white_PunchShort, this, gameTime);
                    else if (animatorator.Stopped())
                        state = State.Idle;
                    else if (animatorator.PlayedToFrame)
                        animatorator.PlayAfter(MainGame.white_PunchShort, this, gameTime);
                    else
                ...
                case State.KickRound:
                    ...
                    if (Keyboard.GetState().IsKeyDown(Keys.Left))
                        animatorator.PlayTo(MainGame.white_KickRound, this, gameTime);
                    else if (animatorator.Stopped())
                        state = State.Idle;
                    else if (animatorator.PlayedToFrame)
                        animatorator.PlayAfter(MainGame.white_KickRound, this, gameTime);
                    else
                        animatorator.RollBack();
                    break;
